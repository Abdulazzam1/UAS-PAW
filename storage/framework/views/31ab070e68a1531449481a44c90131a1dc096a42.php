    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a href="#" class="nav-link"><?php echo e(session('DataLogin')['nama']); ?></a>
                </li>
                <li class="dropdown nav-item">
                    ...
                    <ul class="dropdown-menu dropdown-navbar">
                        <li class="nav-link">
                            <a href="/Logout" class="nav-item dropdown-item"><?php echo e(__('Log out')); ?></a>
                        </li>
                    </ul>
                </li>
...
<?php /**PATH D:\Laravel Source\NewPOS\resources\views/layouts/navbars/navs/auth.blade.php ENDPATH**/ ?>